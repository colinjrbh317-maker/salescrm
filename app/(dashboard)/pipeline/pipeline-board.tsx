                    ...
                    return (
                      <div key={lead.id}>
                        ...
                        <div
                          ...
                          className="cursor-grab rounded-md border border-slate-700 bg-slate-800 p-3 transition-colors hover:border-slate-600 active:cursor-grabbing"
                          onClick={() => router.push(`/leads/${lead.id}`)}
                        >
                        {/* Lead name + hot indicator */}
                        <div className="flex items-center gap-1.5">
